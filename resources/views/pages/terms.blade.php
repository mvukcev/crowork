        ...
        <div class="container-base max-w-4xl">
            ...
            <div class="prose prose-neutral max-w-none space-y-8">
                ...
                <section class="bg-surface rounded-lg border border-border p-8">
                    <h2 class="text-title-2 font-semibold text-text-primary mb-4">Agreement to Terms</h2>
                ...
                <!-- Use of Service -->
                <section class="bg-surface rounded-lg border border-border p-8">
                    <h2 class="text-title-2 font-semibold text-text-primary mb-4">Use of Service</h2>
                    
                    <h3 class="text-subtitle font-semibold text-text-primary mb-3 mt-6">Eligibility</h3>
                    ...
                    <h3 class="text-subtitle font-semibold text-text-primary mb-3">Account Registration</h3>
                    <p class="text-body text-text-secondary mb-4 leading-relaxed">
                    ...
                    <h3 class="text-subtitle font-semibold text-text-primary mb-3">Prohibited Activities</h3>
                    <p class="text-body text-text-secondary mb-4 leading-relaxed">
                        You may not:
                    </p>
                ...
                <!-- For Job Seekers -->
                <section class="bg-surface rounded-lg border border-border p-8">
                    <h2 class="text-title-2 font-semibold text-text-primary mb-4">Terms for Job Seekers</h2>
                    <p class="text-body text-text-secondary mb-4 leading-relaxed">
                ...
                <!-- For Employers -->
                <section class="bg-surface rounded-lg border border-border p-8">
                    <h2 class="text-title-2 font-semibold text-text-primary mb-4">Terms for Employers</h2>
                    <p class="text-body text-text-secondary mb-4 leading-relaxed">
                ...
                <section class="bg-surface rounded-lg border border-border p-8">
                    <h2 class="text-title-2 font-semibold text-text-primary mb-4">Content and Intellectual Property</h2>
                    
                    <h3 class="text-subtitle font-semibold text-text-primary mb-3 mt-6">Your Content</h3>
                    <p class="text-body text-text-secondary mb-4 leading-relaxed">
                    ...
                    <h3 class="text-subtitle font-semibold text-text-primary mb-3">Our Content</h3>
                    <p class="text-body text-text-secondary leading-relaxed">
                ...
                <!-- Disclaimer -->
                <section class="bg-surface rounded-lg border border-border p-8">
                    <h2 class="text-title-2 font-semibold text-text-primary mb-4">Disclaimer of Warranties</h2>
                    <p class="text-body text-text-secondary leading-relaxed">
                ...
                <section class="bg-surface rounded-lg border border-border p-8">
                    <h2 class="text-title-2 font-semibold text-text-primary mb-4">Limitation of Liability</h2>
                    <p class="text-body text-text-secondary leading-relaxed">
                ...
                <!-- Termination -->
                <section class="bg-surface rounded-lg border border-border p-8">
                    <h2 class="text-title-2 font-semibold text-text-primary mb-4">Termination</h2>
                    <p class="text-body text-text-secondary leading-relaxed">
                ...
                <!-- Governing Law -->
                <section class="bg-surface rounded-lg border border-border p-8">
                    <h2 class="text-title-2 font-semibold text-text-primary mb-4">Governing Law and Disputes</h2>
                    <p class="text-body text-text-secondary leading-relaxed">
                ...
                <!-- Changes to Terms -->
                <section class="bg-surface rounded-lg border border-border p-8">
                    <h2 class="text-title-2 font-semibold text-text-primary mb-4">Changes to Terms</h2>
                    <p class="text-body text-text-secondary leading-relaxed">
                ...
                <section class="bg-primary-50 rounded-lg border border-primary-200 p-8">
                    <h2 class="text-title-2 font-semibold text-text-primary mb-4">Contact Information</h2>
                    <p class="text-body text-text-secondary mb-4 leading-relaxed">
                        If you have questions about these Terms, please contact us:
                    </p>
                    <ul class="space-y-2 text-body text-text-secondary">
                        <li><strong>Email:</strong> <a href="mailto:legal@crowork.hr" class="text-primary hover:text-primary-hover transition-colors duration-normal">legal@crowork.hr</a></li>
