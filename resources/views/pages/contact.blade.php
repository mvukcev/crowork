<x-app-layout>
    ...
    <x-slot name="description">Get in touch with the CroWork team.</x-slot>

    <section class="cw-section">
        <div class="cw-container max-w-4xl">
            <p class="cw-kicker mb-3">Contact</p>
            <h1 class="cw-display text-4xl md:text-6xl mb-4">Let us help you move faster.</h1>
            <p class="text-base text-slate-600 mb-8">Reach out for partnership, employer onboarding, worker support, or product questions.</p>
