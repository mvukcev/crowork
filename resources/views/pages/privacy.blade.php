        ...
        <div class="cw-container max-w-4xl">
            ...
            <div class="prose prose-neutral max-w-none space-y-8">
                ...
                <section class="cw-surface p-8">
                    ...
                    <h3 class="text-lg font-semibold text-slate-900 mb-3 mt-6">Personal Information</h3>
                    ...
                    <h3 class="text-lg font-semibold text-slate-900 mb-3">Usage Information</h3>
                    <p class="text-base text-slate-700 leading-relaxed">
                ...
                <!-- Information Sharing -->
                <section class="cw-surface p-8">
                    <h2 class="text-2xl font-semibold text-slate-900 mb-4">Information Sharing and Disclosure</h2>
                    <p class="text-base text-slate-700 mb-4 leading-relaxed">
                ...
                <section class="cw-surface p-8">
                    ...
                    <p class="text-base text-slate-700 mb-4 leading-relaxed">
                        We use cookies and similar tracking technologies to enhance your experience on our platform. You can control cookie preferences through your browser settings. For more information, please see our <a href="{{ route('cookies') }}" class="text-slate-900 hover:text-slate-700 transition-colors duration-150">Cookie Policy</a>.
                    </p>
                </section>
