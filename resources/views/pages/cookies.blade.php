        ...
        <div class="container-base max-w-4xl">
            ...
            <div class="prose prose-neutral max-w-none space-y-8">
                ...
                <section class="bg-surface rounded-lg border border-border p-8">
                    <h2 class="text-title-2 font-semibold text-text-primary mb-4">What Are Cookies?</h2>
                ...
                <!-- How We Use Cookies -->
                <section class="bg-surface rounded-lg border border-border p-8">
                    <h2 class="text-title-2 font-semibold text-text-primary mb-4">How We Use Cookies</h2>
                ...
                <!-- Types of Cookies -->
                <section class="bg-surface rounded-lg border border-border p-8">
                    <h2 class="text-title-2 font-semibold text-text-primary mb-4">Types of Cookies We Use</h2>
                    
                    <div class="space-y-6">
                        <!-- Essential Cookies -->
                        <div>
                            <h3 class="text-subtitle font-semibold text-text-primary mb-3">Essential Cookies</h3>
                            <p class="text-body-sm text-text-secondary mb-2 leading-relaxed">
                                These cookies are necessary for the Platform to function and cannot be disabled. They enable core functionality such as:
                            </p>
                            <ul class="list-disc list-inside space-y-1 text-body-sm text-text-secondary ml-4">
                        ...
                        <!-- Performance Cookies -->
                        <div>
                            <h3 class="text-subtitle font-semibold text-text-primary mb-3">Performance Cookies</h3>
                            <p class="text-body-sm text-text-secondary mb-2 leading-relaxed">
                        ...
                        <div>
                            <h3 class="text-subtitle font-semibold text-text-primary mb-3">Functionality Cookies</h3>
                            <p class="text-body-sm text-text-secondary mb-2 leading-relaxed">
                        ...
                        <!-- Targeting Cookies -->
                        <div>
                            <h3 class="text-subtitle font-semibold text-text-primary mb-3">Targeting/Advertising Cookies</h3>
                            <p class="text-body-sm text-text-secondary mb-2 leading-relaxed">
                ...
                <!-- Third-Party Cookies -->
                <section class="bg-surface rounded-lg border border-border p-8">
                    <h2 class="text-title-2 font-semibold text-text-primary mb-4">Third-Party Cookies</h2>
                    <p class="text-body text-text-secondary mb-4 leading-relaxed">
                ...
                <!-- Cookie Duration -->
                <section class="bg-surface rounded-lg border border-border p-8">
                    <h2 class="text-title-2 font-semibold text-text-primary mb-4">Cookie Duration</h2>
                    
                    <div class="space-y-4">
                        <div>
                            <h3 class="text-subtitle font-semibold text-text-primary mb-2">Session Cookies</h3>
                        ...
                        <div>
                            <h3 class="text-subtitle font-semibold text-text-primary mb-2">Persistent Cookies</h3>
                            <p class="text-body-sm text-text-secondary leading-relaxed">
                ...
                <!-- Managing Cookies -->
                <section class="bg-surface rounded-lg border border-border p-8">
                    <h2 class="text-title-2 font-semibold text-text-primary mb-4">Managing Your Cookie Preferences</h2>
                    
                    <h3 class="text-subtitle font-semibold text-text-primary mb-3 mt-6">Browser Settings</h3>
                    <p class="text-body text-text-secondary mb-4 leading-relaxed">
                        Most web browsers allow you to control cookies through their settings:
                    </p>
                    <ul class="list-disc list-inside space-y-2 text-body-sm text-text-secondary mb-6">
                    ...
                    <h3 class="text-subtitle font-semibold text-text-primary mb-3">Platform Settings</h3>
                    <p class="text-body text-text-secondary mb-4 leading-relaxed">
                    ...
                    <h3 class="text-subtitle font-semibold text-text-primary mb-3">Opt-Out Tools</h3>
                    <p class="text-body text-text-secondary leading-relaxed">
                        For advertising cookies, you can opt out through industry opt-out tools:
                    </p>
                    <ul class="list-disc list-inside space-y-1 text-body-sm text-text-secondary ml-4 mt-2">
                ...
                <!-- Impact of Disabling -->
                <section class="bg-surface rounded-lg border border-border p-8">
                    <h2 class="text-title-2 font-semibold text-text-primary mb-4">Impact of Disabling Cookies</h2>
                    <p class="text-body text-text-secondary mb-4 leading-relaxed">
                ...
                <!-- Changes to Policy -->
                <section class="bg-surface rounded-lg border border-border p-8">
                    <h2 class="text-title-2 font-semibold text-text-primary mb-4">Changes to This Cookie Policy</h2>
                    <p class="text-body text-text-secondary leading-relaxed">
                ...
                <!-- More Information -->
                <section class="bg-surface rounded-lg border border-border p-8">
                    <h2 class="text-title-2 font-semibold text-text-primary mb-4">More Information</h2>
                    <p class="text-body text-text-secondary mb-4 leading-relaxed">
                        For more information about how we handle your personal data, please see our <a href="{{ route('privacy') }}" class="text-primary hover:text-primary-hover transition-colors duration-normal">Privacy Policy</a>.
                    </p>
                    <p class="text-body text-text-secondary leading-relaxed">
                        For general information about cookies, visit <a href="https://www.allaboutcookies.org" target="_blank" rel="noopener noreferrer" class="text-primary hover:text-primary-hover transition-colors duration-normal">www.allaboutcookies.org</a>.
                    </p>
                </section>
