            ...
            <div class="hidden md:flex items-center justify-end gap-2">
                @auth
                    ...
                    @if(auth()->user()->isEmployer())
                        <a href="{{ url('/employer') }}" class="cw-button-secondary">Dashboard</a>
                    @endif
                    @if(auth()->user()->isWorker())
                        <a href="{{ route('worker.applications.index') }}" class="cw-button-secondary">Dashboard</a>
                    @endif
                ...
                @else
                    <a href="{{ route('access.show') }}" class="cw-button-primary">Get started</a>
                @endauth
            </div>
