                ...
                <aside class="lg:col-span-1">
                    <div class="bg-white rounded-2xl shadow-elevation-1 p-6 sticky top-24">
                        ...
                        >
                            ...
                            <!-- Online/In-Person -->
                            <div>
                                <label for="is_online" class="block text-body-sm font-semibold text-text-primary mb-2">
                                    Format
                                </label>
                                <select 
                                    id="is_online" 
                            ...
                            <!-- Start Date From -->
                            <div>
                                <label for="start_from" class="block text-body-sm font-semibold text-text-primary mb-2">
                                    Starting From
                                </label>
                                <input 
                                    type="date" 
                            ...
                            <!-- Maximum Price -->
                            <div>
                                <label for="price_max" class="block text-body-sm font-semibold text-text-primary mb-2">
                                    Max. Price (€)
                                </label>
                                <input 
                                    type="number" 
