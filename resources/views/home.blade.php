<x-app-layout>
    ...
    <x-hero 
        size="lg" 
        title="Find Your Dream Job in Croatia" 
        subtitle="Connect with top employers and discover amazing opportunities tailored for international talent">
        <div class="max-w-2xl mx-auto">
            <!-- Acrylic Search Bar -->
            <form action="{{ route('jobs.index') }}" method="GET" class="relative">
                <div class="acrylic-surface rounded-2xl shadow-elevation-3 p-2 flex gap-2 items-center motion-fade-in" style="animation-delay: 140ms;">
                    <div class="flex-1 flex items-center px-3">
                        ...
                        <input 
                            ...
                            class="flex-1 py-3 text-body bg-transparent border-0 focus:outline-none focus:ring-0 text-text-primary placeholder:text-text-tertiary"
                            value="{{ request('search') }}"
                        >
                    </div>
                    <x-button type="submit" variant="primary" size="lg" class="shadow-md hover:shadow-lg">
                        Search Jobs
                    </x-button>
                </div>
            </form>
