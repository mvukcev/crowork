                ...
                <form method="POST" action="{{ route('employer.settings.profile.update') }}" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="border border-neutral-200 rounded-xl p-5 bg-white/70 backdrop-blur-sm">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-neutral-600 mt-1">{{ __('employer.settings.company_display_name_help') }}</p>
                        </div>
                        ...
                        <div class="mt-5">
                            ...
                            <p class="text-xs text-neutral-600 mt-1">{{ __('employer.settings.company_logo_help') }}</p>
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               required>
                        <p class="text-xs text-neutral-600 mt-1">{{ __('employer.settings.company_name_help') }}</p>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" 
                           ...
                           <p class="text-xs text-neutral-600 mt-1">{{ __('employer.settings.city_help') }}</p>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text"
                           ...
                           <p class="text-xs text-neutral-600 mt-1">{{ __('employer.settings.country_help') }}</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-xs text-neutral-600 mt-1">{{ __('employer.settings.industry_help') }}</p>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="url" 
                           ...
                           <p class="text-xs text-neutral-600 mt-1">{{ __('employer.settings.website_help') }}</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-xs text-neutral-600 mt-1">{{ __('employer.settings.company_description_help') }}</p>
                    </div>
                    ...
                    <div class="border-t border-neutral-200 pt-6">
                        ...
                        <div class="space-y-4">
                            <label class="flex items-start gap-3">
                                ...
                                <div>
                                    <p class="font-medium text-neutral-900">{{ __('employer.settings.relocation_support') }}</p>
                                    <p class="text-sm text-neutral-600">{{ __('employer.settings.relocation_support_help') }}</p>
                                </div>
                            </label>
                            ...
                            <label class="flex items-start gap-3">
                                ...
                                <div>
                                    <p class="font-medium text-neutral-900">{{ __('employer.settings.accommodation_support') }}</p>
                                    <p class="text-sm text-neutral-600">{{ __('employer.settings.accommodation_support_help') }}</p>
                                </div>
                            </label>
                        </div>
                    </div>
                ...
                <div class="cw-surface border border-neutral-200 rounded-lg p-6 mb-6">
                    ...
                    @if($missing)
                        <div class="bg-neutral-50 rounded p-3">
                            <p class="text-xs font-medium text-neutral-700 mb-2">{{ __('employer.settings.missing_fields') }}</p>
